...
def pars_alpha(file_to_read: str, file_to_write: str, sheet_num=0):
    def get_data_to_write():
        data_frame = read_excel(file_to_read, sheet_name=sheet_num)
...
def pars_renaissance(file_to_read: str, file_to_write: str, sheet_num=0):
    def get_data_to_write():
        data_frame = read_excel(file_to_read, sheet_name=sheet_num)
...
def main():
    ...
    for i in range(num_runs):
        ...
        pars_alpha(alpha_file, result_file, sheet_num=0)
        pars_renaissance(renaissance_file, result_file, sheet_num=0)
        print('Pars DONE!')
        print()
